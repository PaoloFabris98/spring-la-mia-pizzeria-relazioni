...
public class Pizza {
    ...
    @ManyToOne
    @JoinColumn(name = "fixedDiscount_id")
    private SpecialOffers fixedDiscount;

    @ManyToOne
    @JoinColumn(name = "percentageDiscount_id")
    private SpecialOffers percentageDiscount;
    ...
    public Pizza(int id, String nome, String descrizione, String foto, double prezzo, Boolean glutine, Boolean lattosio,
            Boolean uova, Boolean frutta_a_guscio,
            Boolean soia, Boolean pesce_e_crostacei, Boolean sesamo, Boolean sedano, Boolean senape) {
        this.id = id;
        this.nome = nome;
    ...
    public SpecialOffers getFixedDiscount() {
        return this.fixedDiscount;
    }

    public void setFixedDiscount(SpecialOffers fixedDiscount) {
        this.fixedDiscount = fixedDiscount;
    }

    public SpecialOffers getPercentageDiscount() {
        return this.percentageDiscount;
    }

    public void setPercentageDiscount(SpecialOffers percentageDiscount) {
